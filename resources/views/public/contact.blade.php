...
<main>
      ...
      <div class="flex flex-col w-11/12 mx-auto">
        <div class="flex flex-col gap-10 mt-10">
          <div class="flex gap-1 text-text14 xl:text-text18">
            <a href="index.html" class="font-regularDisplay text-[#6C7275]"
              >Home</a
            >
            <span>/</span>
            <a href="contacto.html" class="font-mediumDisplay text-[#141718]"
              >Contacto</a
            >
          </div>
        </div>
    ...
    <section class="w-11/12 mx-auto">
      <div class="text-[#151515] flex flex-col gap-16">
        <div class="md:w-8/12 flex flex-col gap-5">
          <h1
            class="font-boldDisplay text-text48 xl:text-text52 leading-none md:leading-tight"
          >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          ...
          <div class="bg-[#F3F5F7] p-4 md:p-24">
            <div
              class="flex flex-col justify-center items-start h-full gap-8"
            >
              <h2
                class="font-mediumDisplay text-text40 xl:text-text44 leading-none md:leading-tight"
              >
                Sobre nosotros
              </h2>

              <div
                class="flex flex-col gap-5 font-regularDisplay text-text16 xl:text-text20"
              >
                <p>
                  Etiam cursus semper odio non consectetur. Pellentesque et
                  molestie risus. Aliquam eu nibh pulvinar.
                </p>
                <p>
                  Etiam cursus semper odio non consectetur. Pellentesque et
                  molestie risus. Aliquam eu nibh pulvinar.
    ...
    <section class="w-11/12 mx-auto my-16">
      <div>
        <h2
          class="font-boldDisplay text-text40 xl:text-text44 text-center my-10 leading-none md:leading-tight"
        >
          Contacta Con Nosotros
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div
            class="flex flex-col gap-1 justify-center items-center bg-[#F3F5F7] py-5 text-text16 xl:text-text20"
          >
            <div class="flex justify-center items-center">
              <img src="./images/svg/icon_direccion.svg" alt="direccion" />
            </div>
            <p class="text-[#6C7275] font-boldDisplay uppercase">Dirección</p>
            <p class="font-boldDisplay text-[#141718]">
              Av.Javier Prado 3423
            </p>
            <p class="font-boldDisplay text-[#141718]">San Isidro - Lima</p>
          </div>
          ...
          >
            <div class="flex justify-center items-center">
              <img src="./images/svg/icon_celular.svg" alt="celular" />
            </div>
            <p class="text-[#6C7275] font-boldDisplay uppercase">TELÉFONO</p>
            <p class="font-boldDisplay text-[#141718]">+51 999 567 890</p>
          </div>
          ...
          >
            <div class="flex justify-center items-center">
              <img src="./images/svg/icon_email.svg" alt="email" />
            </div>
            <p class="text-[#6C7275] font-boldDisplay uppercase">Email</p>
            <p class="font-boldDisplay text-[#141718]">hello@3legant.com</p>
          </div>
        </div>
      </div>

      <div
        class="my-16 grid grid-cols-1 md:grid-cols-2 gap-16 justify-center items-center"
      >
        <form action="#" class="flex flex-col gap-5">
          <div class="flex flex-col gap-2">
            <label
              for="nombre_completo"
              class="font-mediumDisplay text-text12 xl:text-text16 text-[#6C7275]"
              >Nombre</label
            >
            <input
              id="nombre_completo"
        ...
        <div class="flex justify-center items-center">
          <img src="./images/img/mapa.png" alt="ubicacion" />
        </div>
      </div>
    </section>
  </main>
