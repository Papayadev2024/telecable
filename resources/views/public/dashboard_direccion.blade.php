...
<main>
    ...
    <section class="font-poppins my-8 md:my-16">
      <div
        class="flex flex-col gap-12 md:flex-row md:gap-24 w-full md:w-11/12 mx-auto"
      >
        ...
        <div class="basis-7/12 font-poppins w-11/12 md:w-full mx-auto">
          ...
          <div class="flex flex-col gap-5 lg:flex-row lg:gap-10">
            <div
              class="basis-1/2 border-2 border-[#6C7275] rounded-lg p-2 flex flex-col gap-1"
            >
              <div class="flex justify-between items-center">
                ...
                <p
                  class="flex justify-between items-center cursor-pointer gap-1 mostrar-mas"
                >
                  <img src="./images/svg/edit.svg" alt="editar" />
                ...
                <div class="modal-mostrar z-[70]">
                  <div class="modal__mostrar-info">
                    <div
                      class="w-full flex flex-col justify-center h-[500px] md:h-[700px]"
                    >
                      <div class="flex flex-col gap-5 w-full">
                        <div class="flex justify-between items-center w-full">
                          <h2
                            class="font-semibold text-[20px] text-[#151515]"
                          >
                            Dirección de envío
                          </h2>
                        ...
                        <div
                          class="overflow-y-scroll h-[400px] md:h-auto md:overflow-auto flex flex-col gap-10"
                        >
                          <div class="flex flex-col gap-5">
                            <div class="flex flex-col gap-5">
                                  ...
                                  <div class="dropdown w-full">
                                    ...
                                    >
                                      <div class="w-full">
                                        ...
                                        >
                                          <span
                                            class="name inline-block w-full"
                                            >Arequipa</span
                                          >
                                        </label>
                                      </div>
                                  ...
                                  <div class="dropdown-provincia w-full">
                                    ...
                                    >
                                      <div class="w-full">
                                        ...
                                        >
                                          <span
                                            class="name-provincia inline-block w-full"
                                            >Provincia1</span
                                          >
                                        </label>
                                      </div>
                                  ...
                                  <div class="dropdown-distrito w-full">
                                    ...
                                    >
                                      <div class="w-full">
                                        ...
                                        >
                                          <span
                                            class="name-distrito inline-block w-full"
                                            >Distrito 1</span
                                          >
                                        </label>
                                      </div>
