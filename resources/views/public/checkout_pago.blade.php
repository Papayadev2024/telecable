...
<main>
    <section class="font-poppins w-11/12 mx-auto my-12 flex flex-col gap-10">
      ...
      <div class="flex md:gap-10">
        <div
          class="flex justify-between items-center md:basis-8/12 w-full md:w-auto"
        >
          <p
      ...
      <div class="flex flex-col 2md:flex-row gap-16 md:gap-10">
          ...
          <div class="flex flex-col gap-5">
            <div>
              ...
              <div class="flex flex-col gap-8">
                <div
                  class="flex flex-col gap-5 pb-10 border-b-2 border-[#151515]"
                >
                ...
                <div class="flex flex-col gap-5 pb-10">
                  ...
                  >
                    <div
                      class="flex items-center ps-4 border border-[#F3F5F7] rounded-xl"
                    >
                      <input
                        type="radio"
        ...
        <div
          class="basis-4/12 flex flex-col justify-start gap-10 pt-10 md:pt-0 order-1 2md:order-2"
        >
          ...
          <div class="p-4">
            <div class="flex flex-col gap-10">
              <div
                class="flex justify-between bg-white font-poppins border-b-[1px] border-[#E8ECEF] pb-5"
              >
                <div class="flex justify-center items-center gap-5">
                  <div class="bg-[#F3F5F7] rounded-md p-4">
                    <img
                      src="./images/img/bag_img.png"
                      alt="producto"
                      class="w-24"
                    />
                  </div>
                ...
                <div
                  class="flex flex-col justify-start py-2 gap-5 items-center"
                >
