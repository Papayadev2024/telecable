        ...
        {{-- <section class="mt-10 hidden md:block relative">
          ...
          <div class="flex justify-end w-11/12 mx-auto mb-4 z-10">
            <div class="absolute bottom-[-2rem] z-30">
              <a href="https://wa.me/numerooo?text=Hola%20desde%20mi%20sitio%20web" target="_blank" rel="noopener"><img
                  src="./images/img/WhatsApp.png" alt="whatsapp" class="w-20 h-20 rounded-full" /></a>
            </div>
          </div>
        </section> --}}
      ...
      <div class="grid grid-cols-1 gap-12 md:gap-0 md:grid-cols-4 grid-rows-1 pt-12 w-11/12 mx-auto">
        <div class="col-span-1 md:col-span-3 order-1 md:order-1 flex flex-col gap-2">
          ...
          <p class="font-normal text-lg">
            Explora nuestra selección destacada: productos de calidad y tendencia que te encantarán. Descubre lo mejor de
      ...
      <div class="grid grid-cols-1 gap-12 md:gap-0 md:grid-cols-4 grid-rows-1 pt-12 w-11/12 mx-auto">
        <div class="col-span-1 md:col-span-3 order-1 md:order-1">
          ...
          <p class="font-normal text-lg basis-3/6">
            Descuentos irresistibles en productos seleccionados. ¡Aprovecha nuestras ofertas y ahorra en tus compras
            favoritas! ¡No te lo pierdas
          </p>
        </div>
