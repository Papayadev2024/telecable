                                        ...
                                        <a href="{{ $item->link1 }}"
                                            ...
                                            <div>
                                                <svg width="40" height="40" viewBox="0 0 32 32" fill="none"
                                                    ...
                                                    <circle cx="16.0004" cy="16" r="15.1928"
                                                        transform="rotate(3.13121 16.0004 16)" fill="white"
                                                        class="group-hover:fill-bgBlack md:duration-500" />
                                                    <path
                                                        d="M16.8349 12.6311L19.8902 16.2119M19.8902 16.2119L16.4626 19.4382M19.8902 16.2119L12.1107 15.7864"
                                                        stroke="black" stroke-width="1.55824" stroke-linecap="round"
