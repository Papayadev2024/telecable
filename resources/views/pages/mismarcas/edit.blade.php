<x-app-layout title="Editar mismarcas">

  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    <form action="{{ route('mismarcas.update', $mismarcas->id) }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2 ">
                  ...
                  <input type="text" id="title" name="title" value="{{ $mismarcas->title }}"
              ...
              {{-- <div class="md:col-span-5">
                ...
                <div class="relative mb-2 mt-2">
                  ...
                  <textarea type="text" rows="2" id="description" name="description"
                    class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Descripción">{{ $mismarcas->description }}</textarea>
                </div>
              </div>
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                    ...
                    <input type="text" id="botontext1" name="botontext1" value="{{ $mismarcas->botontext1 }}" class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Titulo para botón 1">
                </div>
            </div> --}}
...
{{-- 
            <div class="md:col-span-2">
                ...
                <div class="relative mb-2  mt-2">
                    ...
                    <input disabled type="text" id="link1" name="link1" value="{{ $mismarcas->link1 }}" class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Url para botón 1">
                </div>
            </div> --}}
