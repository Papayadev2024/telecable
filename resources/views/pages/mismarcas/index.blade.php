<x-app-layout title="mismarcases">
                            ...
                            @foreach($mismarcas as $item)
                                <tr>
                                    ...
                                    <td class="flex flex-row justify-end items-center gap-5">
                                        ...
                                        <a href="{{ route('mismarcas.edit', $item->id) }}" class="bg-yellow-400 px-3 py-2 rounded text-white  "><i class="fa-regular fa-pen-to-square"></i></a>
    ...
    <script>
        ...
        $('document').ready(function(){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                                ...
                                url: '{{ route("mismarcas.deleteMisMarcas") }}',
                                method: 'POST',
                                data:{
           ...
           $(document).on("change", ".btn_swithc", function() {
                ...
                $.ajax({
                    url: "{{ route('mismarcas.updateVisible') }}",
                    method: 'POST',
                    data:{
                        _token: $('input[name="_token"]').val(),
                        status: status,
