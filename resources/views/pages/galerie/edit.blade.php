<x-app-layout title="Crear Galeria">
  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    <form action="{{ route('galerie.update', $productsWithGalleries[0]->id) }}" method="POST"
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <select name="product_id" id="product_id" value="{{ $productsWithGalleries[0]->id }}"
                    class=" mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option value="">{{ $productsWithGalleries[0]->producto }}</option>
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="text" id="valor" name="valor"
                    value="{{ $productsWithGalleries[0]->galeria[0]->valor }}"
                    class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Valor">
                </div>
              </div>
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="text" id="descripcion" name="descripcion"
                    value="{{ $productsWithGalleries[0]->galeria[0]->descripcion }}"
                    class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  @if(isset($productsWithGalleries[0]->galeria[0]))
                  <img src="{{ asset($productsWithGalleries[0]->galeria[0]->imagen) }}" class="rounded-lg mb-2 w-52"
                    alt="Imagen actual">
                    @endif
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  @if (isset($productsWithGalleries[0]->galeria[1]))
                    <img src="{{ asset($productsWithGalleries[0]->galeria[1]->imagen) }}" class="rounded-lg mb-2 w-52"
                      alt="Imagen actual">
                  @endif
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  @if (isset($productsWithGalleries[0]->galeria[2]))
                    <img src="{{ asset($productsWithGalleries[0]->galeria[2]->imagen) }}" class="rounded-lg mb-2 w-52"
                      alt="Imagen actual">
                  @endif
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  @if (isset($productsWithGalleries[0]->galeria[3]))
                    <img src="{{ asset($productsWithGalleries[0]->galeria[3]->imagen) }}" class="rounded-lg mb-2 w-52"
                      alt="Imagen actual">
                  @endif
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  @if (isset($productsWithGalleries[0]->galeria[4]))
                    <img src="{{ asset($productsWithGalleries[0]->galeria[4]->imagen) }}" class="rounded-lg mb-2 w-52"
                      alt="Imagen actual">
                  @endif
              ...
              <div class="md:col-span-1">
                ...
                <input type="text" id="color" name="color"
                  value="{{ $productsWithGalleries[0]->galeria[0]->color }}"
