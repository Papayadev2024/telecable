<x-app-layout title="Editar General">
                                                        ...
                                                        <div class="grid grid-cols-1 gap-5">
                                                            ...
                                                            @foreach ($datoscontacto as $item)
                                                                <div class="flex flex-col md:flex-row gap-2 w-full">
                                                                    <div class="relative  mt-2 mb-0 md:mb-2 w-full md:w-1/2 lg:w-1/4">
                                                                        <div
                                                                            ...
                                                                            <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                                                                ...
                                                                                y="0" viewBox="0 0 469.336 469.336"
                                                                    ...
                                                                    <div class="relative  mt-2 w-full md:w-1/2 lg:w-1/4">
                                                                        <div
                                                                            class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                                            <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                                                                xmlns="http://www.w3.org/2000/svg"
    ...
    <script>
        ...
        $('document').ready(function() {
            ...
            const existingInputs = document.querySelectorAll("input[name^='Nombre-']");
              ...
              $("#AddEspecifiacion").on('click', function(e) {
                ...
                dRelative2.classList.add('relative', 'mb-2', 'mt-2','w-full', 'md:w-1/2', 'lg:w-1/4')
                dRelative3.classList.add('relative', 'mb-2', 'mt-2','w-full', 'md:w-1/2', 'lg:w-1/4')
                dRelative4.classList.add('relative', 'mb-2', 'mt-2','w-full', 'md:w-1/2', 'lg:w-1/4')
        ...
        function agregarElementoSelect(elemento, valorInput, name) {
            ...
            let valorAtributo = @json($categorias);
            const optionElement = document.createElement("option");
            optionElement.setAttribute("value", "0");
            optionElement.textContent = name == 'Area' ? 'Area' : " ";
