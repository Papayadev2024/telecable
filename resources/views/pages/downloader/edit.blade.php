<x-app-layout title="Editar Downloader">
  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    <form action="{{ route('descargables.update', $descargables->id) }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                  ...
                  <select name="categoria_id"
                    ...
                    @foreach ($categoria as $item)
                      <option value="{{ $item->id }}"
                        {{ $item->id == $descargables->categoria_id ? 'selected' : '' }}>
                        {{ $item->name }}</option>
                    @endforeach
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2 ">
                  ...
                  <input type="text" id="title" name="title" value="{{ $descargables->title }}"
                    class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Título">
                </div>
              </div>
              ...
              <div class="md:col-span-5">
                <label for="description">Descripción de catalogo</label>
                <div class="relative mb-2 mt-2">
                  ...
                  <textarea type="text" rows="2" id="description" name="description"
                    class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Descripción">{{ $descargables->description }}</textarea>
                </div>
              </div>
              ...
              <div class="md:col-span-5">
                <label for="imagenvista">Imagen</label>
                <div class="relative mb-2 mt-2">
                  <img src="{{ asset($descargables->url_image . $descargables->name_image) }}"
              ...
              <div class="md:col-span-5">
                <label for="archive">Subir catalogo (.pdf)</label>
                <div class="relative mb-2  mt-2">
                    <input name="archive" accept="application/pdf"
                        class="p-2.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
