<x-app-layout title="Liquidaciones">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <section class="py-4 border-b border-slate-100 dark:border-slate-700">
            <a href="{{ route('misclientes.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded text-sm" >Agregar cliente</a>
        </section>
        ...
        <div class="col-span-full xl:col-span-8 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
            ...
            <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Cliente</h2>
            </header>
            <div class="p-3">
                            ...
                            @foreach($misclientes as $item)
                                <tr>
                                    ...
                                    <td class="flex flex-row justify-end items-center gap-5">
                                        ...
                                        <a href="{{ route('misclientes.edit', $item->id) }}" class="bg-yellow-400 px-3 py-2 rounded text-white  "><i class="fa-regular fa-pen-to-square"></i></a>
    ...
    <script>
        ...
        $('document').ready(function(){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                                ...
                                url: '{{ route("misclientes.deleteMisClientes") }}',
                                method: 'POST',
                                data:{
            ...
            $(document).on("change", ".btn_swithc", function() {
                ...
                $.ajax({
                    url: "{{ route('misclientes.updateVisible') }}",
                    method: 'POST',
                    data:{
                        _token: $('input[name="_token"]').val(),
                        status: status,
