<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <form action="{{ route('innovacionesview.update', $innovacionview->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <div class="rounded shadow-lg p-4 px-4 w-full">
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 ">
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2 ">
                                            ...
                                            <input type="text" id="title1section" name="title1section"
                                                value="{{ $innovacionview->title1section }}"
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <input type="text" id="subtitle1section" name="subtitle1section"
                                                value="{{ $innovacionview->subtitle1section }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="url_image1section">Imagen</label>
                                    ...
                                    <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-xl tracking-tight">Hardware y Softare</h2>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <input type="text" id="title2section" name="title2section"
                                                value="{{ $innovacionview->title2section }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese el titulo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <textarea type="text" id="description2section" name="description2section"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese la descripcion">{{ $innovacionview->description2section }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <input type="text" id="title3section" name="title3section"
                                                value="{{ $innovacionview->title3section }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese el titulo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <textarea type="text" id="description3section" name="description3section"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese la descripcion">{{ $innovacionview->description3section }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-xl tracking-tight">Servicios</h2>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <input type="text" id="title4section" name="title4section"
                                                value="{{ $innovacionview->title4section }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese el titulo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <textarea type="text" id="description4section"
                                                ...
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese la descripcion">{{ $innovacionview->description4section }}</textarea>
                                        </div>
                                    </div>
