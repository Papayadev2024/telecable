<x-app-layout title="Editar Producto">
                    ...
                    <div class="flex flex-col md:flex-row  gap-2 p-3 ">
                            ...
                            <div class="rounded shadow-lg p-4 px-4 ">
                                ...
                                <div id='general' class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 ">
                                    ...
                                    <div class="md:col-span-5 mt-2">
                                        ...
                                        <label for="producto">Orden (El menor número se mostrara en primer lugar)</label>
                                    ...
                                    <div class="md:col-span-5 mt-2">
                                        ...
                                        <label for="extract">Descripción - Ejemplo: 200 Mpbs</label>
                                    ...
                                    <div class="md:col-span-5 mt-2">
                                        ...
                                        <label for="name_fichatecnica">Descripción corta - Ejemplo: Velocidad normal 70Mbps</label>
                                        ...
                                        <div class="relative mb-2  mt-2">
                                            ...
                                            <input type="text" id="name_fichatecnica" name="name_fichatecnica"
                                                value="{{ $product->name_fichatecnica }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese datos">
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="description">Velocidad (caracteristica)</label>
                                        <div class="relative mb-2 mt-2">
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="especificacion">Instalación (caracteristica)</label>
                                        <div class="relative mb-2 mt-2"> 
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="sku">Soporte (caracteristica)</label>
                                        <div class="relative mb-2 mt-2"> 
                                            {{-- <x-textarea name="especificacion" value="{!! $product->especificacion !!}" /> --}}
                                            {{-- <textarea class="ckeditor" id="especificacion" name="especificacion">{!! $product->especificacion !!}</textarea> --}}
                                            <div
                        ...
                        <div class="basis-full md:basis-2/5">
                            ...
                            <div
                                ...
                                <div class="md:col-span-5 mt-2 hidden" id="textInput">
                                    <label for="seotitulo">Detalle de Plan Duo Ejemplo: (1 Deco HD + 2 accesos)</label>
                                    <div class="relative mb-2  mt-2">
                                        <div
                                            class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                            <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                ...
                                <div class="md:col-span-5 mt-2 hidden" id="select2Input">
                                    <div class="flex flex-col gap-2">
                                        <label for="canales">Seleccione canales</label>
                                        <div class="w-2/3">
                                            <div class="relative mb-2  mt-2">
                                                <select id="canales" name="canal_id[]" multiple class="w-full">
                                                    @foreach ($canales as $canal)
                                                        <option value="{{ $canal->id }}"
                                                            {{ in_array($canal->id, $product->canals->pluck('id')->toArray()) ? 'selected' : '' }}>
                                                            {{ $canal->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                {{-- <div class="md:col-span-5 flex flex-col md:flex-row">
                                    <div class="w-full lg:w-1/2">
                                        <input type="checkbox" id="checkbox1" class="checkbox text-blue-600 ring-0 focus:ring-0 rounded-sm w-4 h-4" />
                                        <label for="checkbox1" class="ml-2">Es Duo</label>
                                    </div>
                                    <div class="w-full lg:w-1/2">
                                        <input type="checkbox" id="checkbox2" class="checkbox text-blue-600 ring-0 focus:ring-0 rounded-sm w-4 h-4" />
                                        <label for="checkbox2" class="ml-2">Solo cable</label>
                                    </div>
                                </div> --}}
                                        ...
                                        <div class="relative mb-2  mt-2">
                                            <select id="tags_id" name="tags_id[]" multiple class="w-full">
                                                @foreach ($tags as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ in_array($item->id, $product->tags->pluck('id')->toArray()) ? 'selected' : '' }}>
                                                        {{ $item->name }}
                                                    </option>
                                                @endforeach
                                            </select>
    ...
    <script>
       CKEDITOR.replace('descriptionf', {
        ...
        CKEDITOR.replace('especificacionf', {
            toolbar: [
                { name: 'document', items: ['Source'] }, // Código fuente
                { name: 'clipboard', items: ['Cut', 'Copy', 'Paste', '-', 'Undo', 'Redo'] },
                { name: 'styles', items: ['Styles', 'Format', 'FontSize'] }, // Tamaño y fuente
    ...
    <script>
        document.querySelector('select[name="categoria_id"]').addEventListener('change', function() {
            ...
            const select2Input = document.getElementById('select2Input');
            
            // Mostrar u ocultar textInput según la categoría seleccionada (por ejemplo, valor '1')
            if (this.value == 1) {
            ...
            // Mostrar u ocultar select2Input según la categoría seleccionada (por ejemplo, valor '3')
            if (this.value == 3) {
                select2Input.classList.remove('hidden');
            } else {
                select2Input.classList.add('hidden');
            }
        });
    
        // Para asegurarnos de que los inputs se muestren correctamente cuando se cargue la página con una categoría ya seleccionada
