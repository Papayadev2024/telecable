        ...
        <div class="p-3">
          <div class="rounded shadow-lg p-4 px-4 ">
            ...
            <ul
              ...
              <li class="me-2">
                <a href="#" aria-current="page" id="general-tab"
                  class="inline-block p-4  rounded-t-lg active dark:bg-slate-900 text-gray-500 dark:text-slate-200">General</a>
              </li>
              <li class="me-2">
                <a href="#" id="attributes-tab"
                  class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Attributes</a>
              </li>
            ...
            <div id='general' class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 ">
              ...
              <div class="">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="checkbox" id="destacar" name="destacar" value="{{ $product->destacar }}"
              ...
              <div class="">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="checkbox" id="recomendar" name="recomendar" value="{{ $product->recomendar }}"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 "
          ...
          <div id="Attributes" class=" gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 hidden">
