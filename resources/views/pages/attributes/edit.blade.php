<x-app-layout title="Editar Atributos">


    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <form action="{{ route('attributes.update', $attributes->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div
                    ...
                    <div class="rounded shadow-lg p-4 px-4 ">
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            <div class="md:col-span-5 hidden">
                                <label for="attr_id">Tipo de atributo</label>
                                <div class="relative mb-2  mt-2 ">
                                    ...
                                    <select name="typeattribute_id"
                                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        @foreach ($typeatributo as $item)
                                          <option value="{{ $item->id }}"
                                            {{ $item->id == $attributes->type_atributte_id ? 'selected' : '' }}>
                                            {{ $item->name }}</option>
                                        @endforeach
                            ...
                            <div class="md:col-span-5">
                                ...
                                <div class="relative mb-2  mt-2">
                                    <input id="imagen" name="imagen" value="{{ $attributes->imagen }}"
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" id="color" name="color" value="{{ $attributes->color }}"
