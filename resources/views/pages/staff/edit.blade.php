<x-app-layout title="Editar Staff">
    ...
    <form action="{{ route('staff.update', $staff->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div
        ...
        <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
          <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Editar personal: {{ $staff->nombre }} 
          </h2>
        </header>
          ...
          <div class="rounded shadow-lg p-4 px-4 ">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2 mt-2">
                  <img src="{{ asset($staff->url_image . $staff->name_image) }}"
              ...
              <div class="md:col-span-5">
                <label for="imagen">Subir imagen (406x535 px)</label>
                <div class="relative mb-2  mt-2">
